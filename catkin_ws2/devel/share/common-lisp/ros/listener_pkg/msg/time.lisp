...
(cl:defmethod cl:initialize-instance :after ((m <time>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'time)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name listener_pkg-msg:<time> is deprecated: use listener_pkg-msg:time instead.")))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader listener_pkg-msg:time-val is deprecated.  Use listener_pkg-msg:time instead.")
  (time m))

(cl:ensure-generic-function 'cnt-val :lambda-list '(m))
(cl:defmethod cnt-val ((m <time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader listener_pkg-msg:cnt-val is deprecated.  Use listener_pkg-msg:cnt instead.")
  (cnt m))
